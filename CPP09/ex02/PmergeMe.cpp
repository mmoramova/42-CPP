...
/*   Updated: 2024/08/05 18:43:39 by mmoramov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void PmergeMe::_sortByVector(char **input)
{
	...
	std::cout << "Time to process a range of " << vec.size() << " elements: " << elapsed_time << " microseconds" << std::endl;
	std::cout << std::endl;
	}
...
void PmergeMe::_sortByDeque(char **input) {
	...
	std::cout << "Time to process a range of " << deq.size() << " elements: " << elapsed_time << " microseconds" << std::endl;
	std::cout << std::endl;
}
...
void PmergeMe::_printPairs(std::vector<std::pair<int,int> > pairs) {
